...
export default function ProjectsPage() {
    return (
        <>
            {/* Header Section */}
            <section className="overflow-hidden bg-black min-h-[60svh] flex items-center justify-center">
                <div className="container relative z-10 bg-black text-center py-14 sm:py-20">
